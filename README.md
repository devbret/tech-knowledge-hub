...
![Screenshot of the Tech Knowledge Hub web app.](https://hosting.photobucket.com/bbcfb0d4-be20-44a0-94dc-65bff8947cf2/134d8a12-92cd-4e19-8dda-5e403a1f2589.png)
...
3. Clone this repository using `git` by running the following command: `git clone git@github.com:devbret/tech-knowledge-hub.git`

4. Navigate to the repo's directory by running: `cd tech-knowledge-hub`

5. Install the frontend by running: `npm install`

6. Launch the frontend by using the following command: `npm run dev`
