...
export const links: LinkEntry[] = [
  ...
  },
  {
    ...
    description: `...creates open-source tools for biosensing and neuroscience.`,
    category: ["Biohacking", "Hardware"],
  },
  {
    title: "MDN",
    url: "https://developer.mozilla.org/en-US/",
    description: `...resource for web development documentation, covering everything from CSS, HTML, JavaScript, Web APIs, and other web technologies.`,
    category: ["Programming"],
  },
  {
    title: "Let's Encrypt",
    url: "https://letsencrypt.org/",
    description: `...a free, automated, and open Certificate Authority (CA), run for the public's benefit.`,
    category: ["Cybersecurity"],
  },
  {
    title: "Software Heritage",
    url: "https://www.softwareheritage.org/",
    description: `...a nonprofit dedicated to archiving the world's source code.`,
    category: ["Programming"],
  },
  {
    title: "FreeBSD Foundation",
    url: "https://freebsdfoundation.org/",
    description: `...a US-based 501(c)(3) non-profit organization dedicated to supporting the FreeBSD Project and community.`,
    category: ["Other"],
  },
  {
    title: "Ollama",
    url: "https://ollama.com/",
    description: `...lets you use open models with your coding agents so you can spend less while keeping your data private.`,
    category: ["AI", "Programming"],
  },
  {
    title: "QRI",
    url: "https://qri.org/",
    description: `...is a 501(c)(3) non-profit dedicated to developing a mathematical formalization for subjective experience and its emotional valence.`,
    category: ["Biohacking", "Other"],
  },
  {
    title: "AAIF",
    url: "https://aaif.io/",
    description: `We convene leading voices across industry and research to define the frameworks, standards, and collaborations that will guide agentic AI forward.`,
    category: ["AI", "Other"],
  },
  {
    title: "FSF",
